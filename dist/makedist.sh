...
################################################################################
mkdir -p $INSTALLPATH/shapes/dia-ocarina6plus/
mkdir -p $INSTALLPATH/sheets/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina6plus/*.png   $INSTALLPATH/shapes/dia-ocarina6plus/
cp -f $SRCPATH/dia-shapes/shapes/dia-ocarina6plus/*.shape $INSTALLPATH/shapes/dia-ocarina6plus/
