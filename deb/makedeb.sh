...
################################################################################
mkdir -p $INSTALLPATH/usr/share/dia/shapes/dia-ocarina6plus/
mkdir -p $INSTALLPATH/usr/share/dia/sheets/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina6plus/*.png   $INSTALLPATH/usr/share/dia/shapes/dia-ocarina6plus/
cp -v -f $SRCPATH/dia-shapes/shapes/dia-ocarina6plus/*.shape $INSTALLPATH/usr/share/dia/shapes/dia-ocarina6plus/
