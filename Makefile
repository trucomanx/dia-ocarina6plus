...
SHEET_FILE      := 'dia-shapes/sheets/dia-ocarina6plus.sheet'
...
uninstall:
	...
	rm -r -f ~/.dia/sheets/dia-ocarina6plus.sheet
...
clean:
	...
	$(RM) -r dia-shapes/shapes/dia-ocarina6plus/*.shape
	$(RM) -r dia-shapes/shapes/dia-ocarina6plus/*.png
